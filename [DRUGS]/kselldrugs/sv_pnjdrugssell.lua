...
AddEventHandler('polo_drugssell:sellweedpooch', function()
    ...
    if weedpooch > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'T\'as pas de Pochon de Weed! Bouge Ya Zebi.')
    end
end)
...
AddEventHandler('polo_drugssell:sellmorphinepooch', function()
    ...
    if morphinepooch > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'T\'as pas de Morphine! Aze Bouge vite avant que j\'m\'énerve.')
    end
end)
...
AddEventHandler('polo_drugssell:sellopiumpooch', function()
    ...
    if opiumpooch > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'T\'as pas de Pochon de\'Opium! Bouge Ya Zebi.')
    end
end)
...
AddEventHandler('polo_drugssell:sellecstasypooch', function()
    ...
    if ecstasypooch > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'T\'as pas d\'Ecstasy ! Aze Bouge vite avant que j\'m\'énerve.')
    end
end)
...
AddEventHandler('polo_drugssell:sellamphetaminespooch', function()
    ...
    if amphetaminespooch > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'Tu viens chez moi sans drogue ! Fou le camp avant que je te tue !')
    end
end)
...
AddEventHandler('polo_drugssell:sellmethpooch', function()
    ...
    if methpooch > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'T\'as pas de Pochon de Meth! Bouge Ya Zebi.')
    end
end)
...
AddEventHandler('polo_drugssell:selllsdpooch', function()
    ...
    if lsdpooch > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'T\'as pas de Pochon de LSD! Bouge Ya Zebi.')
    end
end)
...
AddEventHandler('polo_drugssell:sellketaminepooch', function()
    ...
    if ketaminepooch > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'T\'as pas de Ketamine ! Aze Bouge vite avant que j\'m\'énerve.')
    end
end)
...
AddEventHandler('polo_drugssell:sellcrackpooch', function()
    ...
    if crackpooch > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'T\'as pas de Pochon de Crack! Bouge Ya Zebi.')
    end
end)
...
AddEventHandler('polo_drugssell:sellmarijuanapooch', function()
    ...
    if marijuanapooch > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'T\'as pas de Marijuana ! Aze Bouge vite avant que j\'m\'énerve.')
    end
end)
