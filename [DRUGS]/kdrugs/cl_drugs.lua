...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~g~Appuyez sur [E] pour Récolter (Weed)')
			inKitchen = true
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~g~Appuyez sur [E] pour traiter (Weed)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~g~Appuyez sur [E] pour Récolter (Coke)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~g~Appuyez sur [E] pour traiter (Coke)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~g~Appuyez sur [E] pour Récolter (Opium)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~w~Appuyez sur [E] pour Récolter (Opium)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~w~Appuyez sur [E] pour traiter (Opium)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.5 then
			ESX.ShowHelpNotification('~p~Appuyez sur [E] pour récolter (Ketamine)')	
			inKitchen = true
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~p~Appuyez sur [E] pour traiter (Ketamine)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~o~Appuyez sur [E] pour récolter (lsd)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 2.0 then
			ESX.ShowHelpNotification('~o~Appuyez sur [E] pour traiter (lsd)')	
			inKitchen = true
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~s~Appuyez sur [E] pour récolter (Morphine)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~s~Appuyez sur [E] pour traiter (Morphine)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~o~Appuyez sur ~b~[E] ~p~pour ~q~Récolter (Lean)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~o~Appuyez sur ~b~[E] ~p~pour ~q~Traiter (Lean)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.5 then
			ESX.ShowHelpNotification('~r~Appuyez sur [E] pour récolter (Heroine)')	
			inKitchen = true
		elseif distance > 1.5 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~r~Appuyez sur [E] pour traiter (Heroine)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~y~Appuyez sur [E] pour récolter (Ecstasy)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~y~Appuyez sur [E] pour traiter (Ecstasy)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~y~Appuyez sur [E] pour récolter (Amphetamines)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~y~Appuyez sur [E] pour traiter (Amphetamines)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~y~Appuyez sur [E] pour récolter (Crack)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~y~Appuyez sur [E] pour traiter (Crack)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~g~Appuyez sur [E] pour récolter (Marijuana)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~g~Appuyez sur [E] pour traiter (Marijuana)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~b~Appuyez sur [E] pour récolter (Meth)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if distance < 1.0 then
			ESX.ShowHelpNotification('~b~Appuyez sur [E] pour traiter (Meth)')	
			inKitchen = true
		elseif distance > 1.0 then
			inKitchen = false
		end
...
function Holograms()
		...
		if GetDistanceBetweenCoords( -708.94, 642.13, 155.17, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( -708.94, 642.13, 155.17  -1.400, "~g~Traiter de la Marijuana", 4, 0.1, 0.1) -- Marijuana
		end
		...
		if GetDistanceBetweenCoords( -2087.97, 2621.70, 1.02, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( -2087.97, 2621.70, 1.02  -1.600, "~d~Traiter de l' Opium", 4, 0.1, 0.1) -- Opium
		end
		...
		if GetDistanceBetweenCoords( -1797.97, 408.92, 113.66, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( -1797.97, 408.92, 113.66  -1.600, "~p~Traiter de la Ketamine", 4, 0.1, 0.1) -- Ketamine
		end
		...
		if GetDistanceBetweenCoords( 244.67, 374.58, 105.73, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( 244.67, 374.58, 105.73  -1.600, "~y~Traiter de la LSD", 4, 0.1, 0.1) -- LSD
		end
		...
		if GetDistanceBetweenCoords( 166.64, 2229.20, 90.76, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( 166.64, 2229.20, 90.76  -1.600, "~j~Traiter de la ~j~Morphine", 4, 0.1, 0.1) -- Morphine
		end
		...
		if GetDistanceBetweenCoords( 725.79, -1071.51, 28.31, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( 725.79, -1071.51, 28.31  -1.600, "~m~Traiter de la ~p~Lean", 4, 0.1, 0.1) -- Lean
		end
		...
		if GetDistanceBetweenCoords( 414.62, 344.27, 102.42, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( 414.62, 344.27, 102.42  -1.600, "~r~Traiter de l' Heroïne", 4, 0.1, 0.1) -- Heroïne
		end
		...
		if GetDistanceBetweenCoords( -157.35, -2206.26, 8.71, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( -157.35, -2206.26, 8.71  -1.600, "~y~Traiter de l' Ecstasy", 4, 0.1, 0.1) -- Ecstasy
		end
		...
		if GetDistanceBetweenCoords( 1268.44, -1710.14, 54.77, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( 1268.44, -1710.14, 54.77  -1.600, "~y~Traiter de l' Amphetamines", 4, 0.1, 0.1) -- OpiAmphetaminesum
		end
		...
		if GetDistanceBetweenCoords( 983.82, 3572.65, 33.57, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( 983.82, 3572.65, 33.57  -1.600, "~y~Traiter du Crack", 4, 0.1, 0.1) -- Crack
		end
	end
end
...
function openWeed()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'weed',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de la Weed', value = 'weed' }, --			
...
function openWeed2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'weed',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter de la Weed', value = 'weed2' }
...
function openCoke()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'coke',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de la Coke', value = 'coke' }
...
function openCoke2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'coke',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter de la Coke', value = 'coke2' }
...
function openOpium()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'opium',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de l\' Opium', value = 'opium' }
...
function openOpium2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'opium',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter l\' Opium', value = 'opium2' }
...
function openKetamine()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'ketamine',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de la Ketamine', value = 'ketamine' }
...
function openKetamine2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'ketamine',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter la Ketamine', value = 'ketamine2' }
...
function openlsd()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'lsd',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de la LSD', value = 'lsd' }
...
function openlsd2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'lsd',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter la LSD', value = 'lsd2' }
...
function openMorphine()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'morphine',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de la Morphine', value = 'morphine' }
...
function openMorphine2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'morphine',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter la Morphine', value = 'morphine2' }
...
function openLean()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'lean',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de la Lean', value = 'lean' }
...
function openLean2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'lean',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter la Lean', value = 'lean2' }
...
function openHeroine()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'heroine',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de l\' Heroine', value = 'heroine' }
...
function openHeroine2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'heroine',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter l\' Heroine', value = 'heroine2' }
...
function openEcstasy()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'ecstasy',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de l\' Ecstasy', value = 'ecstasy' }
...
function openEcstasy2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'ecstasy',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter l\' Ecstasy', value = 'ecstasy2' }
...
function openAmphetamines()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'amphetamines',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de l\' Amphetamines', value = 'amphetamines' }
...
function openAmphetamines2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'amphetamines',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter de l\' Amphetamines', value = 'amphetamines2' }
...
function openCrack()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'crack',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter du Crack', value = 'crack' }
...
function openCrack2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'crack',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter du Crack', value = 'crack2' }
...
function openMarijuana()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'marijuana',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de la Marijuana', value = 'marijuana' }
...
function openMarijuana2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'marijuana',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter la Marijuana', value = 'marijuana2' }
...
function openMeth()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'meth',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour récolter de la Meth', value = 'meth' }
...
function openMeth2()
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'meth',
        {
            ...
            align    = 'top-right',
            elements = { 
                { label = 'Appuyez sur [E] pour traiter la Meth', value = 'meth2' }
...
function OpenPoloDrugsMenuMeth(data2)
		...
		ESX.UI.Menu.Open(
			'default', GetCurrentResourceName(), 'drugs',
			{
				...
				elements = {
				{label = 'Tenue de citoyen', value = 'citizen_wear'},
				{label = 'Tenue de Meth', value = 'drugsmeth_wear'},			
			},
			},
			function(data2, menu)
			local ped = GetPlayerPed(-1)
